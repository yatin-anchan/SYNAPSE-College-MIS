...
class AttendanceReportsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_attendance_reports_hod)
    ...
    private fun bindViews() {
        ...
        btnDefaulterList.setOnClickListener {
            startActivity(Intent(this, DefaulterListActivity::class.java).apply { putExtra("DEPARTMENT_ID",   currentUserDepartmentId) })
        }
    }
    ...
    private fun openStudentAnalysis(report: AttendanceReport) {
        startActivity(Intent(this, StudentAttendanceAnalysisActivity_HOD::class.java).apply {
